...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'f22385ab-f597-11f0-8758-2111f188d389:1-218';
...
BEGIN
    SELECT 
        ...
        a.Referencia,
        a.IdEstadoAsiento
    FROM asiento_contable_encabezado a
    WHERE a.IdPeriodo = p_id_periodo
      AND a.Activo = 1;
END ;;
DELIMITER ;
...
BEGIN
    ...
    SET Activo = 0
    WHERE IdAsientoEncabezado = p_id_asiento
      AND IdEstadoAsiento IN (1, 2) -- Borrador, Pendiente
      AND Activo = 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_asiento_insertar_detalle`(
    IN p_id_asiento INT,
    IN p_id_cuenta INT,
    IN p_tipo_mov CHAR(1),   -- 'D' o 'C'
    IN p_monto DECIMAL(18,2),
    IN p_descripcion VARCHAR(255)
)
BEGIN
    INSERT INTO asientocontabledetalle
    (IdAsientoEncabezado, IdCuentaContable, TipoMovimiento, Monto, Descripcion)
    VALUES
...
BEGIN
    ...
    VALUES
    (
        0,              -- luego se define lógica de consecutivo
        p_fecha,
        p_referencia,
        p_id_periodo,
        1,              -- BORRADOR
...
-- Dump completed on 2026-01-30 19:07:36
