...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_CuentasContablesConteo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`siscontableLaDat`@`%` PROCEDURE `sp_CuentasContablesConteo`(
    IN pI_Tipo ENUM('Activo','Pasivo','Capital','Gasto','Ingreso'),
    IN pI_Estado ENUM('Activa','Inactiva')
)
BEGIN
...
CREATE DEFINER=`siscontableLaDat`@`%` PROCEDURE `sp_CuentasContablesInsertar`(
    ...
    IN pI_CuentaPadre INT,
    IN pI_TipoSaldo ENUM('Deudor','Acreedor'),
    IN pI_AceptaMovimiento TINYINT,
    IN pI_Estado ENUM('Activa','Inactiva'),
...
BEGIN
    ...
    BEGIN
        -- En caso de error
        SET pS_resultado = 0;
        SET pS_IdCuenta = NULL;
    END;

    -- Verifica que el código no exista
    IF EXISTS (SELECT 1 FROM cuentascontables WHERE CodigoCuenta = pI_CodigoCuenta) THEN
        SET pS_resultado = 0;
        SET pS_IdCuenta = NULL;
    ELSE
        ...
        SET pS_IdCuenta = LAST_INSERT_ID();
        SET pS_resultado = 1;
    END IF;
END ;;
DELIMITER ;
...
BEGIN
    ...
    SET 
        ...
        Estado = pI_Estado
    WHERE IdEstadoAsiento = pI_IdEstado;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_EstadoAsientoContableConteo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`siscontableLaDat`@`%` PROCEDURE `sp_EstadoAsientoContableConteo`(
    IN pI_Estado ENUM('Activo','Inactivo')
)
BEGIN
...
BEGIN
    ...
    SET pS_IdEstado = LAST_INSERT_ID();
    SET pS_resultado = 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_PeriodoCerrar` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`siscontableLaDat`@`%` PROCEDURE `sp_PeriodoCerrar`(IN p_IdPeriodo INT, IN p_IdUsuario INT)
BEGIN
    -- DECLARE primero
    ...
    -- SET y lógica después de los DECLARE
    SET v_Fecha = NOW();

    -- Obtener año y mes del periodo a cerrar
    SELECT Anio, Mes INTO v_Anio, v_Mes
    FROM periodocontable
    WHERE IdPeriodo = p_IdPeriodo;

    -- Cerrar todos los periodos abiertos hasta el seleccionado
    UPDATE periodocontable
    SET Estado = 'Cerrado',
        IdUsuarioCierre = p_IdUsuario,
        FechaCierre = v_Fecha
    WHERE Estado = 'Abierto'
      AND (Anio < v_Anio OR (Anio = v_Anio AND Mes <= v_Mes));
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    SELECT 
        ...
        p.Estado,
        p.IdUsuarioCierre,
        CONCAT(u.NombreUsuario, ' ', u.ApellidoUsuario) AS UsuarioCierreNombre,
        p.FechaCierre
    FROM periodocontable p
    LEFT JOIN usuarios u 
        ON p.IdUsuarioCierre = u.IdUsuario
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_PeriodoContableListarAnioMes` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`siscontableLaDat`@`%` PROCEDURE `sp_PeriodoContableListarAnioMes`()
BEGIN
    SELECT 
        IdPeriodo,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_PeriodoReabrir` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`siscontableLaDat`@`%` PROCEDURE `sp_PeriodoReabrir`(IN p_IdPeriodo INT)
BEGIN
    -- Obtener año y mes del periodo a reabrir
    DECLARE v_Anio INT;
    DECLARE v_Mes INT;
    ...
    -- Reabrir todos los periodos cerrados hasta el seleccionado
    UPDATE periodocontable
    SET Estado = 'Abierto',
...
-- Dump completed on 2026-02-14 14:56:26
